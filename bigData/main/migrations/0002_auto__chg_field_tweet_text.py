...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'main_tweet', 'text', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Tweet.text'
        db.alter_column(u'main_tweet', 'text', self.gf('django.db.models.fields.CharField')(max_length=140))
